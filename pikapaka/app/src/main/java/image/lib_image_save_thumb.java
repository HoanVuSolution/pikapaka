...
public class lib_image_save_thumb {
	...
	public lib_image_save_thumb(Context context, String file_url, ImageView imageview)
	{
		try 
		{
	...
	private void f_size_check(String file_url)
	{
		...
		{    	
	    	...
	    	{    	
	    		...
	    		int scale = lib_image_get_scale.f_get_scale(context, imageUri, lib_util_image.required_size_thumb);
