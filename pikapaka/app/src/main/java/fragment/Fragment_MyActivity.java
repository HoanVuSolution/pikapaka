...
public class Fragment_MyActivity extends Fragment {
   ...
   // public static Fragment_MyActivity activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_myactivity, container, false);
        mSocket.connect();
...
//
//        tv_count_f=(TextView)v. findViewById(R.id.tv_count_f);
...
//                                }
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    if (arItem.size()>0){
                        adapter_myactivity adapter = new adapter_myactivity(Fragment_MyActivity.this,arItem);
...
//        });
        ...
        mListView.setOnSwipeListener(new SwipeMenuListView.OnSwipeListener() {
            ...
            public void onSwipeStart(int position) {
                ...
                if(arItem.get(position).type.equals("group")){
                    Toast.makeText(getActivity(),"Can't delete Group",Toast.LENGTH_SHORT).show();
                }
                else{
                    try {
                        dialog();
